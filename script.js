...
function desenharForca() {
    ...
    ctx.lineWidth = 4;
    ctx.beginPath();
    ctx.moveTo(10, 290); ctx.lineTo(290, 290); ctx.stroke(); // base
    ctx.beginPath();
    ctx.moveTo(50, 290); ctx.lineTo(50, 50); ctx.lineTo(150, 50); ctx.lineTo(150, 80); ctx.stroke(); // poste
    if (tentativas <= 5) { ctx.beginPath(); ctx.arc(150, 100, 20, 0, Math.PI * 2); ctx.stroke(); } // cabeça
    if (tentativas <= 4) { ctx.beginPath(); ctx.moveTo(150, 120); ctx.lineTo(150, 200); ctx.stroke(); } // corpo
    if (tentativas <= 3) { ctx.beginPath(); ctx.moveTo(150, 140); ctx.lineTo(120, 170); ctx.stroke(); } // braço esquerdo
    if (tentativas <= 2) { ctx.beginPath(); ctx.moveTo(150, 140); ctx.lineTo(180, 170); ctx.stroke(); } // braço direito
    if (tentativas <= 1) { ctx.beginPath(); ctx.moveTo(150, 200); ctx.lineTo(120, 250); ctx.stroke(); } // perna esquerda
    if (tentativas <= 0) { ctx.beginPath(); ctx.moveTo(150, 200); ctx.lineTo(180, 250); ctx.stroke(); } // perna direita
}
